    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex items-center justify-between gap-4">
        ...
        {canReset && (
          <button 
            onClick={onReset}
            className="text-[9px] font-black text-slate-400 hover:text-rose-500 uppercase tracking-widest transition-colors py-2 px-3 rounded-lg hover:bg-rose-50 dark:hover:bg-rose-950/20 whitespace-nowrap"
          >
            Reset DB
          </button>
        )}
